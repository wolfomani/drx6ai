...
import { Send, Paperclip, Mic, MicOff, Smile, X, ImageIcon } from 'lucide-react';
  ...
  return (
    <div className="p-4 bg-gray-900 border-t border-gray-800">
      <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-3">
            <div className="flex flex-wrap gap-2">
              {attachments.map((file, index) => (
                <div key={index} className="flex items-center gap-2 bg-gray-800 px-3 py-2 rounded-lg text-sm">
        ...
        {audioBlob && (
          <div className="mb-3">
            <div className="flex items-center gap-2 bg-gray-800 px-3 py-2 rounded-lg text-sm">
              ...
              <span className="text-white">تسجيل صوتي</span>
              <Button
                variant="ghost"
                size="sm"
        ...
        {/* Input Container */}
        <div className="relative bg-gray-800 border border-gray-700 rounded-2xl focus-within:border-blue-500 focus-within:shadow-lg focus-within:shadow-blue-500/20 transition-all duration-300">
          ...
          <Textarea
            ...
            className="w-full bg-transparent text-white placeholder-gray-400 resize-none border-none outline-none focus:ring-0 focus:border-transparent pr-16 max-h-32 min-h-[60px]"
            disabled={disabled}
          />
          ...
          <div className="absolute bottom-2 right-2 flex items-center gap-2">
            ...
            <Button
              ...
              className="w-8 h-8 p-0 bg-blue-600 hover:bg-blue-700 text-white rounded-full transition-all duration-300 hover:scale-110 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
